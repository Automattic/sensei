...
class Sensei_Data_Port_Course_Model_Test extends WP_UnitTestCase {
		...
		return [
			[
				[
					...
					Sensei_Data_Port_Course_Model::COLUMN_COURSE            => 'Course <randomtag>title</randomtag>',
				...
				[
					...
					Sensei_Data_Port_Course_Model::COLUMN_COURSE            => 'Course title',
			...
			[
				[
					Sensei_Data_Port_Course_Model::COLUMN_ID                => 'id',
					Sensei_Data_Port_Course_Model::COLUMN_COURSE            => 'Updated title',
					Sensei_Data_Port_Course_Model::COLUMN_SLUG              => 'slug',
			...
			[
				[
					Sensei_Data_Port_Course_Model::COLUMN_COURSE            => 'Course <p>title</p>',
	...
	private function verify_course( WP_Post $course, $line_data, $thumbnail_id = 0 ) {
		...
		$this->assertEquals( $line_data[ Sensei_Data_Port_Course_Model::COLUMN_COURSE ], $course->post_title );
