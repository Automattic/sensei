 ...
 *
 * @covers \Sensei\Student_Progress\Quiz_Progress\Repositories\Comments_Based_Quiz_Progress_Repository
 */
class Comments_Based_Quiz_Progress_Repository_Test extends \WP_UnitTestCase {
	...
	public function testCreate_WhenLessonStatusNotFound_ThrowsException(): void {
		...
		$user_id    = $this->factory->user->create();
		$quiz_id    = $this->factory->quiz->create( [ 'post_parent' => $lesson_id ] );
		$repository = new \Sensei\Student_Progress\Quiz_Progress\Repositories\Comments_Based_Quiz_Progress_Repository();
