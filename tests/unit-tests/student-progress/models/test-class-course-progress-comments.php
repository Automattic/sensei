<?php
/**
 * File containing the Course_Progress_Comments_Test class.
 *
 * @package sensei
 */
...
/**
 * Class Course_Progress_Comments_Test.
 *
 * @covers \Sensei\Student_Progress\Models\Course_Progress_Comments
 */
class Course_Progress_Comments_Test extends \WP_UnitTestCase {
	...
	private function createProgress(): Course_Progress_Comments {
		return new Course_Progress_Comments(
			1,
			2,
			3,
