...
class Sensei_REST_API_Home_Controller_Test extends WP_Test_REST_TestCase {
	...
	public function testHomeDataReturnsQuickLinksGeneratedByProvider() {
		...
		$home_data_mock->expects( $this->any() )
			->method( 'fetch' )
			->willReturn( [] );
		...
		$news_provider   = new Sensei_Home_News_Provider( $home_data_mock );
		$guides_provider = new Sensei_Home_Guides_Provider( $home_data_mock );
