	...
	public function providerSingleRow_ItemGiven_ReturnsMatchingRow() {
		return [
			...
			'with hidden enrolled courses' => [
				...
				'<tr class="alternate"><th class=\'cb column-cb check-column\'  ><label class="screen-reader-text">Select All</label><input type="checkbox" name="user_id" value="1" class="sensei_user_select_id"></th><td class=\'learner column-learner column-primary\' data-colname="Students (0)" ><strong><a class="row-title" href="http://example.org/wp-admin/user-edit.php?user_id=1" title="Edit &#8220;admin&#8221;">admin</a></strong><button type="button" class="toggle-row"><span class="screen-reader-text">Show more details</span></button></td><td class=\'email column-email\' data-colname="Email" >a</td><td class=\'progress column-progress\' data-colname="Enrolled Courses" >0 Courses Enrolled<a href="" class="learner-overview-course-item" data-course-id="2">Course 1</a><a href="" class="learner-overview-course-item" data-course-id="3">Course 2</a><a href="" class="learner-overview-course-item" data-course-id="4">Course 3</a><div class="learner-course-overview-detail" style="display: none"><a href="" class="learner-overview-course-item" data-course-id="5">Course 4</a></div></td><td class=\'last_activity_date column-last_activity_date\' data-colname="Last Activity" >January 1, 2020</td><td class=\'actions column-actions\' data-colname="" ><div class="student-action-menu" data-user-id="1" data-user-name="b"></div></td></tr>',
			],
		];
	}
}
