...
class Email_List_Table_Test extends \WP_UnitTestCase {
	...
	public function testGetRowData_WhenHasItem_ReturnsTheItemRowData() {
		...
		$expected = sprintf(
			...
			'<td class=\'description column-description column-primary\' data-colname="Email" >%5$s<button type="button" class="toggle-row"><span class="screen-reader-text">Show more details</span></button></td><td class=\'subject column-subject\' data-colname="Subject" ><strong><a href="" class="row-title">Email title 0000556</a></strong><div class="row-actions"><span class=\'edit\'><a href="" aria-label="Edit &#8220;%2$s&#8221;">Edit</a> | </span><span class=\'disable-email\'><a href="%3$s" aria-label="Disable &#8220;%2$s&#8221;">Disable</a> | </span><span class=\'preview-email\'><a href="%4$s" aria-label="Preview &#8220;%2$s&#8221;">Preview</a></span></div><button type="button" class="toggle-row"><span class="screen-reader-text">Show more details</span></button></td><td class=\'last_modified column-last_modified\' data-colname="Last Modified" >1 second ago</td></tr>',
			$post->ID,
			$post->post_title,
