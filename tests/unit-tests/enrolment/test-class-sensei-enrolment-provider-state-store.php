...
class Sensei_Enrolment_Provider_State_Store_Test extends WP_UnitTestCase {
	...
	public function testFromJsonString() {
		...
		$state_set = \Sensei_Enrolment_Provider_State_Store::from_json( $data_json );

		$this->assertTrue( $state_set instanceof Sensei_Enrolment_Provider_State_Store, 'JSON should have resulted in a valid state set' );
