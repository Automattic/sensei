...
class Sensei_Class_Student_Test extends WP_UnitTestCase {
    ...
    public function testClassInstance(){
        ...
        $this->assertTrue( class_exists( 'Sensei_Student'), 'the Sensei student class is not loaded' );
    ...
    public function testGetLearnerFullNameBasicAssumptions(){
        ...
        $this->assertTrue( method_exists( 'Sensei_Student', 'get_full_name'),
            'The learner class function `get_full_name` does not exist ' );

        // make sure it blocks invalid parameters and returns false
        $this->assertFalse( Sensei_Student::get_full_name( '' ), 'Invalid user_id should return false'  );
        $this->assertFalse( Sensei_Student::get_full_name( -200 ), 'Invalid user_id should return false'  );
        $this->assertFalse( Sensei_Student::get_full_name( 'abc' ), 'Invalid user_id should return false'  );
        $this->assertFalse( Sensei_Student::get_full_name( 4000000 ), 'Invalid user_id should return false'  );
    ...
    public function testGetLearnerFullName(){
        ...
        $this->assertEquals( 'getlearnertestuser', Sensei_Student::get_full_name( $test_user_id ),
        ...
        $this->assertEquals( 'Test User', Sensei_Student::get_full_name( $test_user_id ),
