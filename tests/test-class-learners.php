...
class Sensei_Class_Learners_Test extends WP_UnitTestCase {
    ...
    public function setUp() {
        ...
        Sensei()->learners = new WooThemes_Sensei_Learners( '' );
    ...
    public function testClassInstance(){
        ...
        $this->assertTrue( isset( Sensei()->learners ), 'the Sensei Learners class is not loaded' );
    ...
    public function testGetLearnerFullNameBasicAssumptions(){
        ...
        $this->assertTrue( method_exists( Sensei()->learners, 'get_learner_full_name'),
            'The learner class function `get_learner_full_name` does not exist ' );

        // make sure it blocks invalid parameters and returns false
        $this->assertFalse( Sensei()->learners->get_learner_full_name( '' ), 'Invalid user_id should return false'  );
        $this->assertFalse( Sensei()->learners->get_learner_full_name( -200 ), 'Invalid user_id should return false'  );
        $this->assertFalse( Sensei()->learners->get_learner_full_name( 'abc' ), 'Invalid user_id should return false'  );
        $this->assertFalse( Sensei()->learners->get_learner_full_name( 4000000 ), 'Invalid user_id should return false'  );
    ...
    public function testGetLearnerFullName(){
        ...
        $this->assertEquals( 'getlearnertestuser', Sensei()->learners->get_learner_full_name( $test_user_id ),
        ...
        $this->assertEquals( 'Test User', Sensei()->learners->get_learner_full_name( $test_user_id ),
