...
- **`Resolves #`** — add the issue number if the user gave one or it's obvious
  from the branch. If you don't know it, leave `Resolves #` as-is for the user to
  fill; don't guess an issue number.
