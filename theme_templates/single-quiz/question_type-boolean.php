...
<li class="boolean">
	...
	<ul class="answers">
		...
		?>
		<li class="<?php esc_attr_e( $answer_class ); ?>"><input type="radio" id="<?php echo esc_attr( 'question_' . $question_id ) . '-option-true'; ?>" name="<?php echo esc_attr( 'sensei_question[' . $question_id . ']' ); ?>" value="true" <?php echo checked( $user_quizzes[ $question_id ], 'true', false ); ?><?php if ( !is_user_logged_in() ) { echo ' disabled'; } ?>>&nbsp;<label for="<?php echo esc_attr( 'question_' . $question_id ) . '-option-true'; ?>"><?php _e( 'True', 'woothemes-sensei' ); ?></label></li>
		<?php
		$answer_class = '';
		if( isset( $user_correct ) ) {
		...
		?>
		<li class="<?php esc_attr_e( $answer_class ); ?>"><input type="radio" id="<?php echo esc_attr( 'question_' . $question_id ) . '-option-false'; ?>" name="<?php echo esc_attr( 'sensei_question[' . $question_id . ']' ); ?>" value="false" <?php echo checked( $user_quizzes[ $question_id ], 'false', false ); ?><?php if ( !is_user_logged_in() ) { echo ' disabled'; } ?>>&nbsp;<label for="<?php echo esc_attr( 'question_' . $question_id ) . '-option-false'; ?>"><?php _e( 'False', 'woothemes-sensei' ); ?></label></li>
	</ul>
	<?php if( $answer_notes ) { ?>
