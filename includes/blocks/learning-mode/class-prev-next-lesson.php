...
class Prev_Next_Lesson {
	 ...
	 * Block JSON file.
	 */
	const BLOCK_JSON_FILE = '/lesson-blocks/learning-mode-prev-next-lesson.block.json';
	...
	private function get_link( $urls, $type, $label, $icon_name, $aria_label ) {
		...
		return ( "
			<{$tag} class='sensei-learning-mode-prev-next-lesson-a sensei-learning-mode-prev-next-lesson-a__next' href='{$url}' aria-label='{$aria_label}' {$disabled_attrs}>
				{$before_icon}
				<span class='sensei-learning-mode-prev-next-lesson-text sensei-learning-mode-prev-next-lesson-text__next'>
					{$label}
				</span>
				{$after_icon}
			</{$tag}>
	...
	public function render( array $attributes, string $content ): string {
		...
		$wrapper_attr = get_block_wrapper_attributes(
			[
				'class' => 'sensei-learning-mode-prev-next-lesson-container',
			]
		);
