...
class Sensei_Autoloader {
	...
	public function initialize_class_file_map() {
		...
		$this->class_file_map = array(
			...
			\Sensei\Quiz_Submission\Grade\Models\Comments_Based_Grade::class => 'quiz-submission/grade/models/class-comments-based-grade.php',
			\Sensei\Quiz_Submission\Grade\Models\Grade_Interface::class => 'quiz-submission/grade/models/class-grade-interface.php',
