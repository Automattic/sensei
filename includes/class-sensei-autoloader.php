...
class Sensei_Autoloader {
	...
	public function initialize_class_file_map() {
		...
		$this->class_file_map = array(
			...
			'Sensei\Blocks\Course_Theme\Course_Content'   => 'blocks/course-theme/class-the-content.php',
			'Sensei\Blocks\Course_Theme\Quiz_Content'     => 'blocks/course-theme/class-the-quiz.php',
		);
	}
