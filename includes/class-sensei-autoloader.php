...
class Sensei_Autoloader {
	...
	public function initialize_class_file_map() {
		...
		$this->class_file_map = array(
			 ...
			 * Learning Mode
			 */
			'Sensei\Blocks\Course_Theme_Blocks'            => 'blocks/learning-mode/class-learning-mode-blocks.php',
			'Sensei\Blocks\Course_Theme\Prev_Next_Lesson'  => 'blocks/learning-mode/class-prev-next-lesson.php',
			'Sensei\Blocks\Course_Theme\Exit_Course'       => 'blocks/learning-mode/class-exit-course.php',
			'Sensei\Blocks\Course_Theme\Course_Title'      => 'blocks/learning-mode/class-course-title.php',
			'Sensei\Blocks\Course_Theme\Course_Navigation' => 'blocks/learning-mode/class-course-navigation.php',
			'Sensei\Blocks\Course_Theme\Site_Logo'         => 'blocks/learning-mode/class-site-logo.php',
			'Sensei\Blocks\Course_Theme\Focus_Mode'        => 'blocks/learning-mode/class-focus-mode.php',
			'Sensei\Blocks\Course_Theme\Notices'           => 'blocks/learning-mode/class-notices.php',
			'Sensei\Blocks\Course_Theme\Lesson_Actions'    => 'blocks/learning-mode/class-lesson-actions.php',
			'Sensei\Blocks\Course_Theme\Quiz_Back_To_Lesson' => 'blocks/learning-mode/class-quiz-back-to-lesson.php',
			'Sensei\Blocks\Course_Theme\Course_Progress_Counter' => 'blocks/learning-mode/class-course-progress-counter.php',
			'Sensei\Blocks\Course_Theme\Course_Progress_Bar' => 'blocks/learning-mode/class-course-progress-bar.php',
			'Sensei\Blocks\Course_Theme\Course_Content'    => 'blocks/learning-mode/class-course-content.php',
			'Sensei\Blocks\Course_Theme\Quiz_Content'      => 'blocks/learning-mode/class-quiz-content.php',
			'Sensei\Blocks\Course_Theme\Post_Title'        => 'blocks/learning-mode/class-post-title.php',
			'Sensei\Blocks\Course_Theme\Lesson_Module'     => 'blocks/learning-mode/class-lesson-module.php',
			'Sensei\Blocks\Course_Theme\Sidebar_Toggle_Button' => 'blocks/learning-mode/class-sidebar-toggle-button.php',
			'Sensei\Blocks\Course_Theme\Quiz_Graded'       => 'blocks/learning-mode/class-quiz-graded.php',
			'Sensei\Blocks\Course_Theme\Quiz_Actions'      => 'blocks/learning-mode/class-quiz-actions.php',
			'Sensei\Blocks\Course_Theme\Page_Actions'      => 'blocks/learning-mode/class-page-actions.php',
			'Sensei\Blocks\Course_Theme\Ui'                => 'blocks/learning-mode/class-ui.php',
			'Sensei\Blocks\Course_Theme\Template_Style'    => 'blocks/learning-mode/class-template-style.php',
			'Sensei\Blocks\Course_Theme\Lesson_Video'      => 'blocks/learning-mode/class-lesson-video.php',
		);
	}
