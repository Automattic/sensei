...
class Sensei_Course_Theme_Lesson {
	...
	/**
	 * Intercepts the notices and prints them out later via 'sensei-lms/learning-mode-notices' block.
	 *
	...
	private function maybe_add_quiz_results_notice() {
		...
		if ( 'ungraded' === $lesson_status->comment_approved ) {
			...
			$text = sprintf( __( 'Your Grade: %s%%', 'sensei-lms' ), '<strong class="sensei-learning-mode-lesson-quiz-notice__grade">' . $grade_rounded . '</strong>' );
		}
