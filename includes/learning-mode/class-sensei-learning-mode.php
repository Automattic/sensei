<?php
/**
 * File containing Sensei_Learning_Mode class.
 *
 * @package sensei-lms
 * @since   3.13.4
 */
...
/**
 * Load the 'Learning Mode' theme for a distraction free experience.
 *
 * @since $$next-version$$
 */
class Sensei_Learning_Mode {
	/**
	...
	public function enqueue_styles() {
		...
		Sensei()->assets->enqueue( self::THEME_NAME . '-script', 'learning-mode/learning-mode.js' );
	...
	public function enqueue_fonts() {
		...
		wp_enqueue_style( 'sensei-learning-mode-fonts', $fonts_url, [], null );
	}
