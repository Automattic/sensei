...
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"116px","right":"20px","bottom":"117px","left":"20px"}}},"className":"sensei-landing-pattern-header","layout":{"type":"constrained","contentSize":"660px"}} -->
<div class="wp-block-group alignfull sensei-landing-pattern-header" style="padding-top:116px;padding-right:20px;padding-bottom:117px;padding-left:20px"><!-- wp:heading {"textAlign":"center","level":1,"style":{"typography":{"textTransform":"uppercase"}},"textColor":"primary"} -->
	<h1 class="has-text-align-center has-primary-color has-text-color" style="text-transform:uppercase"><?php echo __( 'grow your writing Skills with Course', 'sensei-lms' ); ?></h1>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"align":"center","style":{"typography":{"letterSpacing":"-1%","lineHeight":"1.3"},"spacing":{"padding":{"top":"40px","bottom":"40px"}}},"textColor":"primary"} -->
	<p class="has-text-align-center has-primary-color has-text-color" style="padding-top:40px;padding-bottom:40px;letter-spacing:-1%;line-height:1.3"><?php echo __( 'Writing is powerful! Allows you to articulate and explain yourself to others. When done well, it allows you to tell stories that could fascinate millions.', 'sensei-lms' ); ?></p>
	<!-- /wp:paragraph -->

	<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
	<div class="wp-block-buttons"><!-- wp:button {"backgroundColor":"primary","textColor":"background","style":{"border":{"radius":"8px"}}} -->
		<div class="wp-block-button"><a class="wp-block-button__link has-background-color has-primary-background-color has-text-color has-background wp-element-button" style="border-radius:8px"><?php echo __( 'START LEARNING NOW', 'sensei-lms' ); ?></a></div>
		<!-- /wp:button --></div>
	<!-- /wp:buttons --></div>
<!-- /wp:group -->
...
<div class="wp-block-group alignfull sensei-blog-posts-pattern has-foreground-color has-background-background-color has-text-color has-background" style="padding-top:80px;padding-right:20px;padding-bottom:80px;padding-left:20px"><!-- wp:group {"style":{"spacing":{"padding":{"bottom":"40px"}}},"textColor":"primary","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between","verticalAlignment":"top"}} -->
	<div class="wp-block-group has-primary-color has-text-color" style="padding-bottom:40px"><!-- wp:group {"style":{"spacing":{"padding":{"left":"20px"}},"border":{"top":{"width":"0px","style":"none"},"right":{"width":"0px","style":"none"},"bottom":{"width":"0px","style":"none"},"left":{"width":"1px","color":"var:preset|color|primary"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
		<div class="wp-block-group" style="border-top-style:none;border-top-width:0px;border-right-style:none;border-right-width:0px;border-bottom-style:none;border-bottom-width:0px;border-left-color:var(--wp--preset--color--primary);border-left-width:1px;padding-left:20px"><!-- wp:heading {"level":5,"style":{"typography":{"textTransform":"uppercase","lineHeight":"1"},"spacing":{"padding":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}},"className":"sensei-pattern-heading"} -->
			<h5 class="sensei-pattern-heading" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;line-height:1;text-transform:uppercase"><?php echo __( 'Blog posts', 'sensei-lms' ); ?></h5>
			<!-- /wp:heading --></div>
		<!-- /wp:group -->

		<!-- wp:paragraph {"className":"sensei-pattern-header-link"} -->
		<p class="sensei-pattern-header-link"><a href="#"><?php echo __( 'Visit the blog', 'sensei-lms' ); ?></a></p>
		<!-- /wp:paragraph --></div>
	<!-- /wp:group -->
	...
	<div class="wp-block-query"><!-- wp:post-template -->
		...
		<div class="wp-block-group" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"><!-- wp:post-featured-image {"isLink":true,"width":"","height":"218px","align":"center","style":{"border":{"radius":"4px","width":"1px"}},"borderColor":"primary"} /-->

			<!-- wp:post-date {"style":{"spacing":{"padding":{"top":"40px","bottom":"20px"}},"typography":{"lineHeight":"1","letterSpacing":"0.02em"}},"textColor":"primary"} /-->

			<!-- wp:post-title {"isLink":true,"style":{"typography":{"lineHeight":"1","textTransform":"uppercase"},"spacing":{"padding":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}},"textColor":"primary","className":"sensei-pattern-no-underline"} /-->

			<!-- wp:post-excerpt {"style":{"typography":{"lineHeight":"1.3"}}} /--></div>
		<!-- /wp:group -->
		<!-- /wp:post-template --></div>
	<!-- /wp:query --></div>
<!-- /wp:group -->
...
<div class="wp-block-group alignfull sensei-pattern-mail-list" style="padding-top:0px;padding-right:20px;padding-bottom:100px;padding-left:20px"><!-- wp:group {"style":{"spacing":{"padding":{"left":"38px","top":"20px","bottom":"20px"}},"border":{"top":{"width":"0px","style":"none"},"right":{"width":"0px","style":"none"},"bottom":{"width":"0px","style":"none"},"left":{"color":"var:preset|color|foreground"}}},"className":"is-style-group-left-border","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
	<div class="wp-block-group is-style-group-left-border" style="border-top-style:none;border-top-width:0px;border-right-style:none;border-right-width:0px;border-bottom-style:none;border-bottom-width:0px;border-left-color:var(--wp--preset--color--foreground);padding-top:20px;padding-bottom:20px;padding-left:38px"><!-- wp:heading {"textAlign":"left","style":{"typography":{"lineHeight":"1","textTransform":"uppercase"},"spacing":{"padding":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}},"fontFamily":"secondary"} -->
		<h2 class="has-text-align-left has-secondary-font-family" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;line-height:1;text-transform:uppercase"><?php
			echo wp_kses(
...
<div class="wp-block-group alignfull wp-sensei-testimonial-pattern has-background-color has-foreground-background-color has-text-color has-background" style="padding-top:80px;padding-right:20px;padding-bottom:120px;padding-left:20px"><!-- wp:group {"style":{"spacing":{"padding":{"left":"20px","bottom":"0px"}},"border":{"top":{"width":"0px","style":"none"},"right":{"width":"0px","style":"none"},"bottom":{"width":"0px","style":"none"},"left":{"color":"var:preset|color|tertiary","width":"1px"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
	...
	<div class="wp-block-columns" style="padding-top:40px"><!-- wp:column {"verticalAlignment":"bottom","width":"41%"} -->
		...
		<div class="wp-block-column is-vertically-aligned-bottom"><!-- wp:heading {"style":{"spacing":{"margin":{"bottom":"40px"}},"typography":{"lineHeight":"1","textTransform":"uppercase"}},"textColor":"background","fontFamily":"secondary"} -->
