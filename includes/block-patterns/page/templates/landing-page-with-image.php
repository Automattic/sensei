...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"right":"20px","left":"20px","top":"0px","bottom":"60px"},"blockGap":"2.5rem","margin":{"top":"0","bottom":"0"}}},"className":"sensei-landing-pattern-with-image-heading","layout":{"type":"constrained","contentSize":"1000px"}} -->
<div class="wp-block-group alignfull sensei-landing-pattern-with-image-heading" style="margin-top:0;margin-bottom:0;padding-top:0px;padding-right:20px;padding-bottom:60px;padding-left:20px"><!-- wp:columns {"style":{"spacing":{"blockGap":{"top":"20px","left":"20px"}}}} -->
	<div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"center","width":"50%","layout":{"type":"default"}} -->
		...
		<!-- wp:column {"verticalAlignment":"top","width":"50%","style":{"spacing":{"padding":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}}} -->
		<div class="wp-block-column is-vertically-aligned-top" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;flex-basis:50%"><!-- wp:image {"id":3136,"sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"4px","width":"1px"}},"borderColor":"primary","className":"is-style-default"} -->
			<figure class="wp-block-image size-full has-custom-border is-style-default"><img src="<?php echo esc_url( Sensei()->assets->get_image( 'landing-page-heading.png' ) ); ?>" alt="" class="has-border-color has-primary-border-color wp-image-3136" style="border-width:1px;border-radius:4px"/></figure>
			<!-- /wp:image --></div>
		<!-- /wp:column --></div>
	<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<div class="wp-block-group alignfull sensei-course-theme-course-list-pattern has-background-color has-primary-background-color has-text-color has-background has-link-color" style="padding-top:5rem;padding-right:20px;padding-bottom:100px;padding-left:20px">
	...
	<div class="wp-block-group" style="border-left-color:var(--wp--preset--color--background);border-left-width:1px;margin-bottom:40px;padding-left:20px">
		<!-- wp:heading {"style":{"typography":{"textTransform":"uppercase","lineHeight":"1"},"spacing":{"padding":{"top":"0px"}}},"textColor":"background","className":"sensei-pattern-heading","fontSize":"medium"} -->
		<h2 class="sensei-pattern-heading has-background-color has-text-color has-medium-font-size" style="padding-top:0px;line-height:1;text-transform:uppercase"><strong><?php echo esc_html__( 'Course list', 'sensei-lms' ); ?></strong></h2>
		<!-- /wp:heading -->
...
<div class="wp-block-group alignfull sensei-blog-posts-pattern has-foreground-color has-background-background-color has-text-color has-background" style="padding-top:80px;padding-right:20px;padding-bottom:80px;padding-left:20px">
	...
	<div class="wp-block-group has-primary-color has-text-color" style="padding-bottom:40px">
		...
		<div class="wp-block-group" style="border-top-style:none;border-top-width:0px;border-right-style:none;border-right-width:0px;border-bottom-style:none;border-bottom-width:0px;border-left-color:var(--wp--preset--color--primary);border-left-width:1px;padding-left:20px">
			<!-- wp:heading {"style":{"typography":{"textTransform":"uppercase","lineHeight":"1"},"spacing":{"padding":{"top":"0px"}}},"textColor":"primary","className":"sensei-pattern-heading","fontSize":"medium"} -->
			<h2 class="sensei-pattern-heading has-primary-color has-text-color has-medium-font-size" style="padding-top:0px;line-height:1;text-transform:uppercase"><?php echo esc_html__( 'Blog posts', 'sensei-lms' ); ?></h2>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:group -->
...
<div class="wp-block-group alignfull wp-sensei-testimonial-pattern has-background-color has-foreground-background-color has-text-color has-background" style="padding-top:80px;padding-right:20px;padding-bottom:120px;padding-left:20px">
	...
	<div class="wp-block-group" style="border-top-style:none;border-top-width:0px;border-right-style:none;border-right-width:0px;border-bottom-style:none;border-bottom-width:0px;border-left-color:var(--wp--preset--color--tertiary);border-left-width:1px;padding-bottom:0px;padding-left:20px">
		<!-- wp:heading {"style":{"typography":{"textTransform":"uppercase","lineHeight":"1"},"spacing":{"padding":{"top":"0px"}}},"textColor":"background","className":"sensei-pattern-heading","fontSize":"medium"} -->
		<h2 class="sensei-pattern-heading has-background-color has-text-color has-medium-font-size" style="padding-top:0px;line-height:1;text-transform:uppercase"><?php echo esc_html__( 'What students say', 'sensei-lms' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-columns" style="padding-top:40px">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:41%">
			<!-- wp:image {"id":2150,"sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"8px","width":"1px"}},"borderColor":"background"} -->
