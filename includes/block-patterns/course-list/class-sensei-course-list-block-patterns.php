			...
			'course-grid-with-background' =>
				[
					...
					'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"5rem","right":"20px","left":"20px","bottom":"100px"},"blockGap":"0px"},"elements":{"link":{"color":{"text":"var:preset|color|background"}}}},"backgroundColor":"primary","textColor":"background","className":"sensei-course-theme-course-list-pattern","layout":{"type":"constrained","contentSize":""}} -->
						...
						<div class="wp-block-group" style="border-left-color:var(--wp--preset--color--background);border-left-width:1px;margin-bottom:40px;padding-left:20px"><!-- wp:heading {"level":5,"style":{"typography":{"textTransform":"uppercase","lineHeight":"1"},"spacing":{"padding":{"top":"0px"}}},"textColor":"background","className":"sensei-course-list-pattern-heading"} -->
						<h5 class="sensei-course-list-pattern-heading has-background-color has-text-color" style="padding-top:0px;line-height:1;text-transform:uppercase"><strong>' . __( 'Course list', 'sensei-lms' ) . '</strong></h5>
						<!-- /wp:heading -->
