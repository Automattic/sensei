...
class Sensei_Admin {
	...
	private function has_custom_navigation( $screen ) {
		...
		/**
		 * Allows modifying the list of pages where the scripts for custom
		 ...
		 *
		 * @since $$next-version$$
		 * @hook sensei_custom_navigation_allowed_pages
		 *
		 * @param {array} $page_list Pages where custom navigation scrips will be loaded.
		 *
		 * @return {array} Pages where custom navigation scrips will be loaded.
		 */
