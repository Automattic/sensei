...
class Sensei_Learners_Admin_Bulk_Actions_Controller {
	...
	public function handle_http_post() {
		...
		// Log event: when course completion (with notification) is bulk recalculated.
		if ( 'complete_course' === $sensei_bulk_action ) {
			...
			sensei_log_event( 'learner_management_course_completion_bulk_recalculate_notify', $event_properties );
