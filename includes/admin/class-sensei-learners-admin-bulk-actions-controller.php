...
class Sensei_Learners_Admin_Bulk_Actions_Controller {
	...
	public function handle_http_post() {
		...
		// Log event: when learners are bulk removed from a course.
		if ( self::REMOVE_MANUAL_ENROLMENT === $sensei_bulk_action ) {
			...
			sensei_log_event( 'learner_management_learner_bulk_remove', $event_properties );
