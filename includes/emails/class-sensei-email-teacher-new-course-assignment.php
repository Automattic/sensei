...
class Sensei_Email_Teacher_New_Course_Assignment {
	...
	function trigger( $teacher_id = 0, $course_id = 0 ) {
		...
		$this->heading = apply_filters( 'sensei_email_heading', __( 'Course assigned to you', 'sensei' ), $this->template );
		$this->subject = apply_filters( 'sensei_email_subject', __( 'New course assigned to you', 'sensei' ), $this->template );
