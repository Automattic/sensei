...
<div id="mc_embed_signup">
	...
	>
		...
		<div id="mc_embed_signup_scroll">
			<h2><?php esc_html_e( 'Join Sensei\'s Mailing List!', 'sensei' ); ?></h2>
			<p>
				<?php esc_html_e( "We're here for you — get tips, product updates, and inspiration straight to your mailbox.", 'sensei' ); ?>
			</p>
			<div>
				<div class="gdpr-checkbox">
					<label class="checkbox subfield" for="gdpr_email">
						...
						<span><?php esc_html_e( 'Yes, please send me occasional emails about Sensei', 'sensei' ); ?></span>
					</label>
				</div>
			</div>
			<div class="email-input">
				<div class="mc-field-group">
					<input type="email" value="<?php echo esc_attr( get_option( 'admin_email', '' ) ); ?>" name="EMAIL" class="required email" id="mce-EMAIL" placeholder="<?php esc_attr_e( 'Enter your email address', 'sensei' ); ?>">
				</div>
			...
			<div class="buttons clear">
				<a href="#close" id="mc-embedded-cancel" class="button" rel="modal:close"><?php esc_html_e( 'Not Now', 'sensei' ); ?></a>
				<input type="submit" value="<?php esc_attr_e( 'Yes, please!', 'sensei' ); ?>" name="subscribe" id="mc-embedded-subscribe" class="button-primary" disabled>
			</div>
		</div>
	</form>
</div>
