 ...
 *
 ************************************/
add_action( 'woocommerce_delete_shop_order_transients',           array( 'Sensei_WC', 'complete_order' ),1 );
add_action( 'woocommerce_delete_shop_order_transients',            array( 'Sensei_WC', 'cancel_order' ), 1 );
