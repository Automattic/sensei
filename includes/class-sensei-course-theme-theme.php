<?php
/**
 * File containing Sensei_Theme class.
 *
 * @package sensei-lms
 * @since   3.13.4
 */
 ...
 * @since 3.13.4
 */
class Sensei_Course_Theme_Theme {
	/**
	...
	/**
	 * Sensei_Theme constructor. Prevents other instances from being created outside of `self::instance()`.
	 */
