<?php
/**
 * File containing the Tables_Based_Quiz_Progress class.
 *
 * @package sensei
 */
...
/**
 * Class Tables_Based_Quiz_Progress.
 *
 * @internal
 *
 * @since $$next-version$$
 */
class Tables_Based_Quiz_Progress implements Quiz_Progress_Interface {
	/**
	 * Progress identifier.
	 *
	 * @var int
