...
class WooThemes_Sensei_Course {
	...
	public function load_user_courses_content( $user = false, $manage = false ) {
		...
		if( $manage && ( ! isset( $woothemes_sensei->settings->settings['messages_disable'] ) || ! $woothemes_sensei->settings->settings['messages_disable'] ) ) {
			?>
			<p><a href="<?php echo get_post_type_archive_link( 'sensei_message' ); ?>" title="<?php _e( 'View & reply to private messages sent to your course & lesson teachers.', 'woothemes-sensei' ); ?>"><?php _e( 'My Messages', 'woothemes-sensei' ); ?> &rarr;</a></p>
			<?php
		}
		?>
		<div id="my-courses">
