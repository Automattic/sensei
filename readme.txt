...
- Add student progress migration [#7049](https://github.com/Automattic/sensei/pull/7049)
...
- Updates the `sensei_results_links` filter to include the learner's user ID when displaying public profiles and to display results links publicly. [#7048](https://github.com/Automattic/sensei/pull/7048)
