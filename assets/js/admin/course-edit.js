jQuery( document ).ready( function( $ ) {
	...
	// Log when the "Manage Learners" link on the Edit Course page is clicked.
	jQuery( '#manage-learners-course-button').on( 'click', function(){
		sensei_log_event( 'course_manage_learners_click', '' );
	});
