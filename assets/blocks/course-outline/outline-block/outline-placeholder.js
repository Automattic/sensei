 ...
 *
 * @param {Object}   props
 * @param {Function} props.generateWithAi
 */
const OutlinePlaceholderWithAi = ( { generateWithAi = noop } ) => {
	const onGeneratedWithAIClick = useCallback( () => {
		generateWithAi();
	}, [ generateWithAi ] );
		...
		>
			<div className="wp-block-sensei-lms-course-outline__placeholder-items">
				...
				<div className="wp-block-sensei-lms-course-outline__placeholder-item is-ai">
					...
					<AiLessonsImage />
					<Button
						className="wp-block-sensei-lms-course-outline__generation-option-button"
						onClick={ onGeneratedWithAIClick }
					>
