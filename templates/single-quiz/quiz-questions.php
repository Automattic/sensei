    ...
    <?php if ( 0 <= $quiz_passmark && 0 < count( $lesson_quiz_questions ) ) { ?>
    	<p>
           ...
           <?php } elseif ( !is_user_logged_in() ) { ?>
            ...
            <?php } elseif ( isset( $user_lesson_complete ) && $user_lesson_complete ) {
                if ( isset( $user_quiz_grade ) && abs( $user_quiz_grade ) >= 0 ) {
                    ...
                    <div class="woo-sc-box info"><?php echo sprintf( __( 'You have completed this quiz and it will be graded soon. You require %1$d%% to pass.', 'woothemes-sensei' ), round( $quiz_passmark_float ) ); ?></div>
                <?php }
            } else { ?>
