...
<p style="<?php echo esc_attr( $style_small ); ?>">
	<?php echo esc_html__( 'was submitted for review by ', 'sensei' ) . esc_html( $sensei_email_data['teacher']->display_name ); ?>
</p>
...
<p style="<?php echo esc_attr( $style_small ); ?>">
	...
	echo esc_html__( 'You can review and publish the new course here:  ', 'sensei' ) . '<a href="' . esc_url( $sensei_email_data['course_edit_link'] ) . '">' . esc_html( $sensei_email_data['course_name'] ) . '</a>';
